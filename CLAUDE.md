...
**Tapi angka itu dari lingkungan TANPA Supabase, dan sapuan itu sendiri yang
menolak menyebutnya hijau** — 6 permukaan (target Kas RT, menu aksi tarikan,
revisi jadwal) tak pernah terbuka karena pemicunya butuh data, dan luapan teks
bergantung pada STRING NYATA. Ia keluar `PROBE CACAT`, bukan lulus. **Verdict
penuh baru ada sesudah ia dijalankan sekali lawan DB hidup.**
