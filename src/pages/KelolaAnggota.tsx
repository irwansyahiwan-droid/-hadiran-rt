...
function AnggotaFormModal({ mode, initial, selesaiTarikan, onClose, onSaved }: FormProps) {
  ...
  const input =
    'w-full px-3.5 py-3 rounded-xl bg-gray-50 dark:bg-gray-800 border border-control dark:border-gray-700 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500';
