    ...
    <div className="space-y-6 pb-2 page-enter">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-9 py-2.5 rounded-2xl bg-white dark:bg-gray-900 border border-control dark:border-gray-700 text-sm dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition duration-200"
        />
        {search && (
