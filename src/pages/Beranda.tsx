        ...
        {trxItems.length > 0 && (
          ...
          <div className="relative px-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-11 py-2.5 rounded-xl bg-white dark:bg-gray-900 border border-control dark:border-gray-700 text-sm dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500"
            />
            {trxSearch && (
