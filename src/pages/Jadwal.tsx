            ...
            return (
              ...
              >
                ...
                {isBendahara && isSelesai ? (
                  ...
                  <button
                    onClick={() => setSelectedTarikan(t)}
                    className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-emerald-500 text-white text-[10px] font-bold hover:bg-emerald-600 active:scale-95 transition-all shrink-0 shadow-sm shadow-emerald-200"
                  >
