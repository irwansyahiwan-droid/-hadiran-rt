...
import {
  DatabaseBackup, Download, Upload, AlertTriangle, RefreshCw, CheckCircle2,
} from 'lucide-react';
...
export default function BackupRestore({ open, onClose }: Props) {
  ...
  return (
    <div ref={dlg.panelRef} {...dlg.panelProps} className={`fixed inset-0 z-overlay bg-sunken dark:bg-gray-950 ${exit.closing ? 'page-out-right' : 'page-in-right'} overflow-y-auto`}>
      <OverlayHeader icon={DatabaseBackup} title="Backup & Restore" onBack={exit.requestClose} />
      ...
      <main className="max-w-lg mx-auto px-4 py-4 space-y-4" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom) + 2rem)' }}>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl border border-line dark:border-gray-800/60 lift p-5">
          ...
          <button
            ...
            disabled={backingUp}
            className="btn-brand w-full min-h-[44px] py-3 text-body flex items-center justify-center gap-2"
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="btn-danger press flex-1 min-h-[44px] py-3 text-body disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
